...
//        this.background = background;
        ...
        const clickHandler = (event) => {
            ...
            if (x >= 520 && x <= 590 && y >= 380 && y <= 460) {
                ...
                this.field = "images/background/cosmicRift.png";
                this.fieldName = "Cosmic Rift";
                this.draw();
    ...
    draw() {
        ...
        this.ctx.fillStyle = "orange";
        this.ctx.font = "30px sans-serif";
        this.ctx.fillText("Choose field: ", 570, 330);

        this.ctx.fillStyle = "orange";
        this.ctx.font = "25px sans-serif";
        this.ctx.fillText(this.fieldName + " selected", 570, 370);

        const image = new Image();
        image.src = "images/costumize.png";
        image.onload = () => {
        this.ctx.drawImage(image, 280, 380, 180, 180);
        };
    ...
    drawField(){
        ...
        image7.src = "images/background/cosmicRift.png";
        image7.onload = () => {
